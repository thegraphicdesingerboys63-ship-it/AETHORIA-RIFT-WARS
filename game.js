...
async function loadShop() {
  ...
  for (const c of cosmetics) {
    ...
    item.innerHTML = `
      ...
      <div class="shop-item-char">${c.character_id === 'ALL' ? 'All Characters' : c.character_id}</div>
      <div class="shop-item-type">${c.type}</div>
      <div class="shop-item-price">${c.owned ? '✓ OWNED' : `${c.price} Shards`}</div>
  ...
  document.getElementById('shop-currency').textContent = `Rift Shards: ${me.currency}`;
}
